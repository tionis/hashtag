...
func newSnapCommand() *cobra.Command {
	...
	logFlags.String("since", "", "Lower time bound for snapshots (e.g. 2026-03-01, -24h, 7d)")
	logFlags.String("until", "", "Upper time bound for snapshots (e.g. 2026-03-02T12:00:00Z)")
	logFlags.Bool("files", false, "Include changed-file list for each snapshot stat range")
	logFlags.Int("files-limit", 50, "Maximum changed files per snapshot when -files is set (0 for all)")
	...
	statusFlags.String("from-time", "", "From snapshot time selector (e.g. 2026-03-01T10:00:00Z, -24h)")
	statusFlags.String("to-time", "", "To snapshot time selector (e.g. 2026-03-01T12:00:00Z)")
	...
	diffFlags.String("from-time", "", "From snapshot time selector (e.g. 2026-03-01T10:00:00Z, -24h)")
	diffFlags.String("to-time", "", "To snapshot time selector (e.g. 2026-03-01T12:00:00Z)")
